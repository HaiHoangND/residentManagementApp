...
import com.hust.edu.vn.residentialmanagementapp.databinding.FragmentVisitorQrBinding
...
class VisitorQrFragment : Fragment() {
    private val viewModel: UserViewModel by activityViewModels()
    private lateinit var binding: FragmentVisitorQrBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentVisitorQrBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val visitorRequest = true
        binding.generateQr.setOnClickListener {
            val visitorName = binding.visitorName.text.toString()
            val task = binding.reason.text.toString()
            if (visitorName.isNotEmpty() && task.isNotEmpty()) {
                ...
                // Hiển thị thông báo nếu không đầy đủ thông tin
                Toast.makeText(requireContext(), "Xin điền đầy đủ thông tin", Toast.LENGTH_SHORT)
                    .show()
            }
        }
